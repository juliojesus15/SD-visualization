...
export const Dashboard = () => {
  ...
  return (
    <div className="w-screen h-screen bg-gray-200 flex flex-col gap-1.5 p-2 dark:bg-dark-200" >
      ...
      <section className="flex flex-col lg:flex-row gap-2 h-[45%] [&>*]:bg-gray-100 [&>*]:dark:bg-dark-100 [&>*]:border [&>*]:border-gray-300 [&>*]:dark:border-gray-600 [&>*]:rounded-lg">
        <div className="h-96 lg:h-auto w-full lg:w-1/3 overflow-hidden">
          <Table /> 
        </div>
